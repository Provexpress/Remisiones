...
<body style="margin: 0; padding: 16px 0; background-color: #F1F5F9; font-family: 'Segoe UI', Arial, sans-serif; color: #0F172A;">
  <center>
    <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color: #F1F5F9;">
      <tr>
        <td align="center" style="padding: 12px;">

          <!-- TARJETA PRINCIPAL 680PX -->
          <table role="presentation" width="680" border="0" cellpadding="0" cellspacing="0" style="width: 680px; max-width: 680px; background-color: #FFFFFF; border-radius: 18px; overflow: hidden; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.06); border: 1px solid #E2E8F0; padding: 24px 28px;">
            <tr>
              <td>
                ...
                <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 20px;">
                  <tr>
                    <td width="200" valign="middle" align="left">
                      <img src="cid:logo_provexpress" alt="Provexpress" width="180" style="display: block; width: 180px; max-width: 180px; height: auto;">
                    </td>
                ...
                <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color: #1E3A8A; border-radius: 14px; padding: 18px 22px; margin-bottom: 20px; color: #FFFFFF;">
                  <tr>
                    <td>
                      <div style="font-size: 11px; font-weight: 700; color: #93C5FD; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 4px;">
                        Reporte Consolidado de Gestión Comercial
                      </div>
                      <div style="font-size: 20px; font-weight: 900; color: #FFFFFF; margin-bottom: 6px;">
                        Hola, Angélica Caballero 👋
                      </div>
                      <div style="font-size: 12.5px; color: #E0E7FF; line-height: 1.4;">
                  ...
                  <tr>
                    <td width="24%" valign="top" style="padding-right: 8px;">
                      <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color: #F8FAFC; border: 1.5px solid #E2E8F0; border-radius: 12px; padding: 12px 10px;">
                        <tr>
                          <td>
                            <div style="font-size: 10px; font-weight: 800; color: #64748B; text-transform: uppercase;">👥 Ejecutivos</div>
                            <div style="font-size: 19px; font-weight: 900; color: #1E3A8A; margin-top: 4px;">${activeCount} / ${totalExecs}</div>
                    ...
                    <td width="24%" valign="top" style="padding-right: 8px;">
                      <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color: #F8FAFC; border: 1.5px solid #E2E8F0; border-radius: 12px; padding: 12px 10px;">
                        <tr>
                          <td>
                            <div style="font-size: 10px; font-weight: 800; color: #64748B; text-transform: uppercase;">📦 Remisiones</div>
                    ...
                    <td width="28%" valign="top" style="padding-right: 8px;">
                      <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color: #F8FAFC; border: 1.5px solid #E2E8F0; border-radius: 12px; padding: 12px 10px;">
                        <tr>
                          <td>
                            <div style="font-size: 10px; font-weight: 800; color: #15803D; text-transform: uppercase;">💵 Valor Grupo</div>
                    ...
                    <td width="24%" valign="top">
                      <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color: #F8FAFC; border: 1.5px solid #E2E8F0; border-radius: 12px; padding: 12px 10px;">
                        <tr>
                          <td>
                            <div style="font-size: 10px; font-weight: 800; color: #DC2626; text-transform: uppercase;">⏱ Antigüedad</div>
                ...
                <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 8px;">
                  <tr>
                    <td>
                      <div style="font-size: 14px; font-weight: 850; color: #1E293B;">
                ...
                <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #E2E8F0; border-radius: 12px; overflow: hidden; border-collapse: separate; border-spacing: 0; margin-bottom: 18px;">
                  <thead>
                    <tr style="background-color: #1E293B; color: #FFFFFF;">
                      <th style="padding: 10px 12px; text-align: left; font-size: 11px; font-weight: 700;">Ejecutivo Comercial</th>
                      <th style="padding: 10px 12px; text-align: center; font-size: 11px; font-weight: 700;">Remisiones</th>
                      <th style="padding: 10px 12px; text-align: right; font-size: 11px; font-weight: 700;">Valor Total</th>
                      <th style="padding: 10px 12px; text-align: center; font-size: 11px; font-weight: 700;">Días Prom.</th>
                      <th style="padding: 10px 12px; text-align: left; font-size: 11px; font-weight: 700;">Remisión Crítica</th>
                ...
                <!-- TOP OPORTUNIDADES GRUPO (ANCHO COMPLETO) -->
                ...
                <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color: #FFFFFF; border: 1.5px solid #E2E8F0; border-radius: 12px; padding: 14px 18px; margin-bottom: 14px;">
                  ...
                  <tr>
                    ...
                    <td valign="middle" style="padding-right: 14px;">
                      ...
                      <div style="font-size: 15px; font-weight: 900; color: #1E3A8A; margin: 1px 0;">
                        ${topMayorValor.doc?.startsWith('REM-') ? topMayorValor.doc : `REM-${topMayorValor.doc}`}
                      </div>
                      <div style="font-size: 11px; color: #475569; max-width: 220px;">
                        ${topMayorValor.company} · <em>${topMayorValor.emp}</em>
                      </div>
                    </td>
                    <td width="130" valign="middle" style="padding-right: 14px;">
                      <div style="font-size: 15px; font-weight: 900; color: #15803D;">
                    ...
                    <td valign="middle" align="right">
                      <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td valign="middle" style="font-size: 11.5px; font-weight: 850; font-style: italic; color: #15803D; line-height: 1.2;">
                  ...
                  <tr>
                    ...
                    <td width="130" valign="middle" style="padding-right: 14px;">
                      <div style="font-size: 15px; font-weight: 900; color: #1E3A8A;">
                    ...
                    <td width="95" valign="middle" style="padding-right: 14px;">
                      <div style="font-size: 14.5px; font-weight: 900; color: #DC2626;">
                    ...
                    <td valign="middle" align="right">
                      <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td valign="middle" style="font-size: 11.5px; font-weight: 850; font-style: italic; color: #DC2626; line-height: 1.2;">
                ...
                <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color: #F8FAFC; border: 1.5px solid #E2E8F0; border-radius: 14px; padding: 16px 22px;">
                  <tr>
                    ...
                    <td valign="middle">
                      ...
                      <div style="font-size: 13.5px; font-weight: 850; color: #1E3A8A; margin-top: 2px;">
                    ...
                    <td valign="middle" style="padding-left: 10px;">
                      ...
                      <div style="font-size: 11.5px; font-weight: 600; color: #334155; margin: 1px 0;">
                        Gerencia Administrativa y Financiera
                      </div>
                      <div style="font-size: 12px; font-weight: 850; color: #2563EB;">
                        PROVEXPRESS SAS
                      </div>
                    </td>
                  </tr>
  ...
  // 5. Cargar Logo para adjunto inline CID
